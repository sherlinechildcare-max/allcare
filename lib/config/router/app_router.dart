...
import 'package:allcare/features/home/presentation/client_profile_tab.dart';
import 'package:allcare/features/home/presentation/client_messages_tab.dart';
import 'package:allcare/features/home/presentation/client_requests_tab.dart';
import 'dart:async';
...
import 'package:allcare/features/home/ui/main_shell.dart';
import 'package:allcare/features/home/presentation/client_home_tab.dart';
class AppRouter {
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) => const ClientRequestsTabScreen(),
          ),
          GoRoute(
            path: '/client/messages',
            builder: (context, state) => const ClientMessagesTabScreen(),
          ),
          GoRoute(
            path: '/client/profile',
            builder: (context, state) => const ClientProfileTabScreen(),
          ),
        ],
      ),
    ],
