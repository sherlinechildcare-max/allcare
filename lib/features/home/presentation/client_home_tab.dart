...
class _ClientHomeTabScreenState extends State<ClientHomeTabScreen> {
  ...
  final bool _isOffline = false; // flip true when connectivity says offline
  final bool _locationDenied = false; // flip true when location permission denied
  final bool _needsSetup = true; // profile incomplete/payment missing/etc.
  final bool _needsPayment = false; // show payment reminder when needed
  final bool _needsSubscription = false; // monetization hook placeholder
